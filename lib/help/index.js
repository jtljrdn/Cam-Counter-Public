...
const page2 = new EmbedBuilder()
  ...
  .addFields(
    ...
    {
      name: "/role list [role]",
      value: "DISABLED: **Manage Roles** Lists all users with role.",
    },
    {
      name: "/role info [role]",
      value: "DISABLED: **Manage Roles** Shows info on role.",
    },
    {
...
const page3 = new EmbedBuilder()
  ...
  .addFields(
    ...
    {
      name: "/fn jamtrack [track]",
      value: "Shows information on Fortnite Festival jamtracks.",
    },
    { name: "/avatar (user)", value: "Gives a users avatar" },
    { name: "/vote", value: "Vote for CamBot" }
  )
...
const page4 = new EmbedBuilder()
  ...
  .addFields(
    ...
    {
      name: "/poll create [question] [option1] [option2] (option3) (option4) (option5) (option6)",
      value: "Create a reaction poll.",
    },
    {
      name: "/valorant match-info [matchID]",
      value: "Gets data from a Valorant match.",
    }
  )
  .setFooter({ text: "Page 3/3" });
