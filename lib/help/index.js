...
const page3 = new EmbedBuilder()
  ...
  .addFields(
    ...
    { name: "/poll create [question] [option1] [option2] (option3) (option4) (option5) (option6)", value: "Create a reaction poll." },
    { name: "/valorant match-info [matchID]", value: "Gets data from a Valorant match." },
  )
  .setFooter({ text: "Page 3/3" });
