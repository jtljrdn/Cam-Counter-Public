...
function updateStatus(client) {
  const StatusList = [
    { name: "Need help? /help", type: ActivityType.Playing },
    ...
    { name: "Use /invite to invite me to your server!", type: ActivityType.Playing },
    { name: "Role commands added!", type: ActivityType.Playing },
    { name: "Use /fn itemshop to see the item shop!", type: ActivityType.Playing },
    { name: "Now with Fortnite commands!", type: ActivityType.Playing },
    { name: `${client.guilds.cache.size} Guilds!`, type: ActivityType.Watching },
  ];
